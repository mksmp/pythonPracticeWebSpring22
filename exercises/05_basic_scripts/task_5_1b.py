...
list_pars = ', '.join(london_co[device_name])
device_par = input(
    'Введите имя параметра ({}): '.format(list_pars)).lower()
result = london_co[device_name].get(
    '{}'.format(device_par), 'Такого параметра нет')
print(result)